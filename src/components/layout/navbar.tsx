...
export async function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-[var(--color-nav-border)] bg-[var(--color-nav-bg)]/95 backdrop-blur supports-[backdrop-filter]:bg-[var(--color-nav-bg)]/85">
